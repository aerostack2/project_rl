...
class AS2GymnasiumEnv(VecEnv):
    ...
    def step_wait(self) -> None:
        for idx, drone in enumerate(self.drone_interface_list):
            ...
            frontier, self.path_length, result = self.action_manager.take_action(
...
if __name__ == "__main__":
    ...
    # df.to_csv('csv/time_graphics_10_episodes/hybrid_075_025.csv', index=False)
    df2.to_csv('csv/bars_graphic_cum_mean_path_length/enormous_density/hybrid_025_075.csv', index=False)
